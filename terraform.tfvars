...
security_groups_details = {
  name        = { alb = "App-Load-Balancer-SG", ssh = "SSH-SG", web = "Web-Server-SG" }
  description = { alb = "Application Load Balancer Security Group", ssh = "SSH Security Group", web = "Web Server Security Group" }
}